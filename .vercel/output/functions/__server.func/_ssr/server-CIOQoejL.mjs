import "../_runtime.mjs";
import { A as resolveManifestCssLink, D as getScriptPreloadAttrs, I as rootRouteId, L as isNotFound, M as isRedirect, N as isResolvedRedirect, O as getStylesheetHref, a as replaceSsrResponse, d as RouterProvider, i as normalizeSsrResponse, j as executeRewriteInput, k as resolveManifestAssetLink, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, z as invariant } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { i as requestHandler, r as getResponse } from "./createMiddleware-DZKjvFNc.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C7N7B4XA.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BdUnzDu0.mjs"),
		import("./start-DPgAUviL.mjs"),
