...
function ListingsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background w-full max-w-full overflow-x-hidden">
      ...
      <div className="mx-auto flex w-full max-w-[1400px] flex-1 min-w-0 gap-6 px-4 py-8 sm:px-6">
        <FilterSidebar
        ...
        <main className="flex-1 min-w-0">
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <Link
                to="/wanted"
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 rounded-full border-2 border-primary/30 bg-primary/10 px-3.5 py-2.5 text-xs font-black uppercase tracking-wider text-primary hover:bg-primary/20 transition sm:px-4 sm:text-sm text-center"
              >
                <Megaphone className="h-4 w-4 shrink-0" /> Wanted
              </Link>
              <button
                type="button"
                onClick={() => {
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 rounded-full bg-gradient-primary px-4 py-2.5 text-xs font-black uppercase tracking-wider text-primary-foreground shadow-glow transition hover:scale-105 sm:px-6 sm:py-3 sm:text-sm text-center"
              >
                <Plus className="h-4 w-4 shrink-0" /> List an item
              </button>
            </div>
          </div>
